...
namespace ScreenSpy
{
    public class Sqlite
    {
        ...
        public void UpdateData(SQLiteConnection conn, string ImageWidth, string ImageHeight, string ProgramDirectory, string DuplicateImgSensitivity, string CaptureFrequency, int ColorPictures)
        {
            try
            {
                ...
                command.CommandText = $"UPDATE ScreenSpy SET ImageWidth = {ImageWidth}, ImageHeight = {ImageHeight}, ProgramDirectory = {ProgramDirectory}, DuplicateImgSensitivity = {DuplicateImgSensitivity}, CaptureFrequency = {CaptureFrequency}, ColorPictures = {ColorPictures} WHERE ID= 1;";
